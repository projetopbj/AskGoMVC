...
<head>
  ...
  <title>Criar Usuario - AskGo</title>
</head>
<body>
            ...
            <div class="card-body">
			  ...
			  <form:form method="post" action="${url}" modelAttribute="usuario">
                ...
                <div class="form-group">
				  <label>Email<label>
				  <form:input  path="email" type="email" class="form-control" placeholder="Seu email"/>
                <div class="form-group">
                  <label>Senha</label>
				   <form:input path="senha" type="password" class="form-control" placeholder="Senha"/> <form:errors path="senha" class="error" /> </div> 
                <div class="form-group">
                  <label>Nome</label>
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control-file" id="inlineFormInput" placeholder="Jane Doe">
                </div>
                <td><input type='submit' value='Salvar' /> Criar Conta</td>
              </form:form>
            </div>
          </div>
        </div>
